...
acoustic shape (brightness, musical key, dynamics, tempo, breaths).
...
def hear(audio_path: str, lang: str = "en") -> str:
    ...
    sound's brightness, musical key, dynamics, tempo, and breath/pause timing.
    ...
    Returns:
        A formatted "WHAT I HEARD" card. Requires ffmpeg on PATH and an Inworld
        key (INWORLD_API_KEY or INWORLD_KEY_PATH).
    """
    try:
